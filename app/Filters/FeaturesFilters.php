...
class FeaturesFilters extends ParentFilter
{
    ...
    public function dt_from_date($startDate = null)
    {
        if ($startDate) {
            ...
            return $this->builder->where('t_features.dt_created_date', '>=', $startDate);
        }
    ...
    public function dt_to_date($endDate = null)
    {
        if ($endDate) {
            ...
            return $this->builder->where('t_features.dt_created_date', '<=', $endDate);
        }
